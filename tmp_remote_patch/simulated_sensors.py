...
class SimulatedSensors:
  ...
  def send_camera_images(self, world: 'World'):
    ...
    road_yuv = self.camerad.rgb_to_yuv(world.road_image)
    wide_yuv = None
    if world.dual_camera:
      wide_yuv = self.camerad.rgb_to_yuv(world.wide_road_image)

    frame_time_ns = time.monotonic_ns()
    self.camerad.cam_send_yuv_road(road_yuv, timestamp_ns=frame_time_ns)

    if world.dual_camera:
      self.camerad.cam_send_yuv_wide_road(wide_yuv, timestamp_ns=frame_time_ns)
