...
tmux new-session -d -s official_sim "bash -lc 'source /home/ubuntu/openpilot/.venv/bin/activate && cd /home/ubuntu/openpilot && DISPLAY=:1 ./tools/sim/launch_openpilot.sh'"
